...
<div class="table-wrap">
  <table id="shot-list-table">
    <thead>
      <tr>
        <th>#</th><th>Scene</th><th>Shot</th><th>Film</th>
...
function editShotList(id) {
  ...
  form.querySelector('[name="location_id"]').value = s.lokasi_id || '';
